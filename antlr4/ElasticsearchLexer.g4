...
//
////GEO
//GEOHASH: G E O H A S H; //经纬度计算全都转换为geohash计算
//
////GROUPING
...
//	POW | ABS |EXP | EXPM1 | AVG | COUNT | MAX | MIN | SUM | COS | SIN |TAN | COT | CBRT | CEIL | LOG |
//	LOG10 | FLOOR | PI | RANDOM | ROUND | SIGN | SQRT | ACOS | ASIN | ATAN | ATAN2 | COSH | SINH | DEGREES | RADIANS | CAST |
//	CONVERT | GEOHASH | UPPER | LOWER | LEN | CONCAT | ASCII | CHAR | BIT_LENGTH | LCASE | LEFT | LENGTH |
//	LOCATE | LTRIM | OCTET_LENGTH | POSITION | REPEAT | REPLACE | RIGHT | RTRIM | FSPACE | UCASE | SUBSTRING |
//	HEX | BIN |
//	NOW
//;
//
